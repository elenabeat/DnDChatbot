...
def title() -> None:
    ...
    st.title("Rules with Advantage")
    st.write(
        "Welcome to the Rules with Advantage chatbot! Ask me any question about the rules of Dungeons & Dragons, 5e and I'll do my best to help you out."
    )
